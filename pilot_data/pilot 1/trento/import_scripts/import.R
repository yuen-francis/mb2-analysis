...
lab_dir = "pilot_data/pilot 1/trento"

# fixed screen resolution which was incrementing in original file
p <- readxl::read_xlsx(here(lab_dir, "raw_data/babylab-trento-participants.xlsx"))

# TODO: row 41892 does not parse correctly
# fixed participant 2 naming convention
d = read_tsv(here(lab_dir, "raw_data/babylab-trento.tsv") )
