...
```{r, eval=FALSE}
# This part does not reflect the refactoring of the folders yet, need to be modified and checked by someone that has access to Eyelink license
labs <- dir(here::here("pilot_data"))

for (lab in labs) {
  print(lab)
  source(here::here("pilot_data/pilot 1", lab, "import_scripts", "import.R"))
}
...
```{r}
labs_1 <- dir(here::here("pilot_data/pilot 1"))
labs_1b <- dir(here::here("pilot_data/pilot 1b"))

d1 <- labs_1 %>%
  map_df(function(labs_1) {
    aoi_data <- read_csv(here(paste0("pilot_data/pilot 1/",
                                     labs_1,"/processed_data/aoi_data.csv"))) 
    subjects <- read_csv(here(paste0("pilot_data/pilot 1/",
                                     labs_1,"/processed_data/subjects.csv"))) 
    trials <- read_csv(here(paste0("pilot_data/pilot 1/",
                                   labs_1,"/processed_data/trials.csv"))) 
    datasets <- read_csv(here(paste0("pilot_data/pilot 1/",
                                     labs_1,"/processed_data/datasets.csv")))
...
d2 <- labs_1b %>%
  map_df(function(labs_1b) {
    aoi_data <- read_csv(here(paste0("pilot_data/pilot 1b/",
                                     labs_1b,"/processed_data/aoi_data.csv"))) 
    subjects <- read_csv(here(paste0("pilot_data/pilot 1b/",
                                     labs_1b,"/processed_data/subjects.csv"))) 
    trials <- read_csv(here(paste0("pilot_data/pilot 1b/",
                                   labs_1b,"/processed_data/trials.csv"))) 
    datasets <- read_csv(here(paste0("pilot_data/pilot 1b/",
                                     labs_1b,"/processed_data/datasets.csv")))
